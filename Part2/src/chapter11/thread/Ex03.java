...
public class Ex03 {
    public static void main(String[] args) {
        Thread tarzanSong = new Thread(new TarzanRun(20));
        tarzanSong
//                .run(); // 타잔 노래가 끝나야 입력에 응답 가능
        ...
        try (Scanner sc = new Scanner(System.in)) {
            while (sc.hasNext()) {
                ...
                if(line.equalsIgnoreCase("ch")){
                    System.out.println("아직 안끝남? ");
                    System.out.println(tarzanSong.isAlive() ? "ㅇㅇ" : "끝남");
                }

                if (line.equalsIgnoreCase("ej")) {
